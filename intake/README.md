...
**No real sensor readings and no account credentials** — this repo is intended to be public.
Redact or synthesize before dropping anything captured from the sensor or its cloud service.
